...
import com.shops.Mukhir.activities.CurrentOrderDetailActivity;
import com.shops.Mukhir.activities.PastOrderDetailActivity;
...
import com.shops.Mukhir.models.Item;
import com.shops.Mukhir.models.Order;
import com.shops.Mukhir.models.OrderModel;
        ...
        holder.itemLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (list.get(section).getHeader().equalsIgnoreCase("Current Orders")) {
                    ...
                    context1.startActivity(new Intent(context1, CurrentOrderDetailActivity.class).putExtra("is_order_page",true).putExtra("order_no",list.get(section).getOrders().get(relativePosition).getOrder_no()));
                } else {
                    GlobalData.isSelectedOrder = list.get(section).getOrders().get(relativePosition);
