...
import com.shops.Mukhir.adapter.OrderFlowAdapter;
...
import com.shops.Mukhir.fragments.OrderViewFragment;
import com.shops.Mukhir.helper.CustomDialog;
import com.shops.Mukhir.helper.DataParser;
import com.shops.Mukhir.helper.GlobalData;
import com.shops.Mukhir.models.Message;
import com.shops.Mukhir.models.Order;
import com.shops.Mukhir.models.OrderFlow;
...
import static com.shops.Mukhir.helper.GlobalData.ORDER_STATUS;
import static com.shops.Mukhir.helper.GlobalData.isSelectedOrder;
...
public class CurrentOrderDetailActivity extends AppCompatActivity implements OnMapReadyCallback, LocationListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //git remote add origin https://github.com/ankitshrivastava00/mukhirUser.git
    ...
    private void getOrderStatus() {
        try {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, BuildConfigure.CLIENT_BASE_URL+"api/get-order-details",
                    new com.android.volley.Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                String success =object.getString("success").trim();;

                                Log.d("Currenterere1 ",response);
                                if (success.equalsIgnoreCase("true")) {
                                    // Log.e(TAG, "Exception in onPaymentSuccess", e);
                                    String order_type =object.getJSONObject("data").getString("order_type").trim();
                                    String status =object.getJSONObject("data").getString("status").trim();
                                    getOrderLocation();
                                } else {
                ...
                protected Map<String, String> getParams() {
                        ...
                        params.put("user_id", "5d82008e7252cf304f2dba12");
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(CurrentOrderDetailActivity.this);
    ...
    private void getOrderLocation() {
        try {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST,
                    BuildConfigure.CLIENT_BASE_URL+"api/get-order-tracking-location",
                    new com.android.volley.Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
                            ...
                            try {
                                JSONObject object = new JSONObject(response.trim());
                                String success =object.getString("success").trim();;
                                Log.d("CurrenterereLocation ",response);

                                if (success.equalsIgnoreCase("true")) {
                                    // Log.e(TAG, "Exception in onPaymentSuccess", e);
                                    String lat =object.getJSONObject("data").getJSONObject("location").getString("lat").trim();
                                    String lng =object.getJSONObject("data").getJSONObject("location").getString("lng").trim();
    ...
    private String getUrl(double source_latitude, double source_longitude, double dest_latitude, double dest_longitude) {
        ...
        return "https://maps.googleapis.com/maps/api/directions/" + output + "?" + parameters +"&key=AIzaSyAuxmmUPDIXgiw84E9AX7bbbdFzkd0xd50";    }
