...
public class SaveDeliveryLocationActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    com.shops.Mukhir.models.Address address = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        address = new com.shops.Mukhir.models.Address();
...
//            getAddress( location.getLatitude(), location.getLongitude());
    ...
    public void getAddress(final Context context, final double latitude, final double longitude) {
        ...
        Call<ResponseBody> call = apiInterface.getResponse(latitude + "," + longitude,
                context.getResources().getString(R.string.p_apikey));
...
//            getAddress(context, srcLat, srcLng);
    ...
    private void saveAddress() {
        if (address != null && address.getMapAddress() != null && validate()) {
            ...
            Call<com.shops.Mukhir.models.Address> call = apiInterface.saveAddress(address);
            call.enqueue(new Callback<com.shops.Mukhir.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.shops.Mukhir.models.Address> call, @NonNull Response<com.shops.Mukhir.models.Address> response) {
                ...
                @Override
                public void onFailure(@NonNull Call<com.shops.Mukhir.models.Address> call, @NonNull Throwable t) {
    ...
    private void updateAddress() {
        ...
        if (address != null && address.getId() != null && validate()) {
            customDialog.show();
            apiInterface = ApiClient.getRetrofit().create(ApiInterface.class);
            Call<com.shops.Mukhir.models.Address> call = apiInterface.updateAddress(address.getId(), address);
            call.enqueue(new Callback<com.shops.Mukhir.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.shops.Mukhir.models.Address> call, @NonNull Response<com.shops.Mukhir.models.Address> response) {
                    customDialog.dismiss();
