...
public class SaveDeliveryLocationActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    com.shops.chiggys.models.Address address = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        address = new com.shops.chiggys.models.Address();
...
//            getAddress(context, srcLat, srcLng);
    ...
    private void saveAddress() {
        if (address != null && address.getMapAddress() != null && validate()) {
            ...
            Call<com.shops.chiggys.models.Address> call = apiInterface.saveAddress(address);
            call.enqueue(new Callback<com.shops.chiggys.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.shops.chiggys.models.Address> call, @NonNull Response<com.shops.chiggys.models.Address> response) {
                ...
                @Override
                public void onFailure(@NonNull Call<com.shops.chiggys.models.Address> call, @NonNull Throwable t) {
    ...
    private void updateAddress() {
        ...
        if (address != null && address.getId() != null && validate()) {
            customDialog.show();
            apiInterface = ApiClient.getRetrofit().create(ApiInterface.class);
            Call<com.shops.chiggys.models.Address> call = apiInterface.updateAddress(address.getId(), address);
            call.enqueue(new Callback<com.shops.chiggys.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.shops.chiggys.models.Address> call, @NonNull Response<com.shops.chiggys.models.Address> response) {
                    customDialog.dismiss();
