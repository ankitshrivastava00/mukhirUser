...
import com.shops.chiggys.adapter.AccountPaymentAdapter;
//import com.shops.app.braintree.CreateTransactionActivity;
//import com.shops.app.braintree.Settings;
...
import static com.shops.chiggys.helper.GlobalData.cardArrayList;
import static com.shops.chiggys.helper.GlobalData.currencySymbol;
import static com.shops.chiggys.helper.GlobalData.isCardChecked;
...
//    private ProgressDialog mLoading;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tamt=getIntent().getIntExtra("tamount",0);
...
//        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        onlinepaylayout =(RelativeLayout)findViewById(R.id.onlinelayout);
        ...
        onlinepayBox = (RadioButton)findViewById(R.id.add_new_cart);
...
//                }
        ...
        proceedToPayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (onlinepayBox.isChecked()) {
                    Intent myIntent = new Intent(AccountPaymentActivity.this, PaymentActivity.class);
                    myIntent.putExtra("tamt",tamt);
                    AccountPaymentActivity.this.startActivity(myIntent);
